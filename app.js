...
random.getNotRandomNumber = function (seed) {
    var mayName = "getNotRandomNumber";
    if (seed) {
        seeds[mayName] = seed;
    }
    else {
...
random.getRandomNumberByMiddleSquareMethod = function (seed) {
    var first = null;
    if (seed) {
        first = core_1.default.getSuuNumber(seed);
    }
    else {
        seed = "1234";
        first = core_1.default.getSuuNumber(seed);
