...
describe("core", function(){
  ...
  describe("add", function(){
    ...
    it("10 + 0.5 = 10.5", () => {
      const res = core.add("10", "0.5");
      const str = core.numArrayToString(res);
      assert.equal(str, "10.5");
    });

    it("9 + 1.5 = 10.5", () => {
      const res = core.add("9", "1.5");
      const str = core.numArrayToString(res);
      assert.equal(str, "10.5");
    });
    ...
    it("10 - 0.5 = 9.5", () => {
      const res = core.subtract("10", "0.5");
      const str = core.numArrayToString(res);
    ...
    it("10.1 - -100 = 110.1", () => {
      const res = core.subtract("10.1", "-100");
      const str = core.numArrayToString(res);
      assert.equal(str, "110.1");
    });
    
    it("10 - -100.5 = 110.5", () => {
      const res = core.subtract("10", "-100.5");
      const str = core.numArrayToString(res);
    ...
    it("0 - 0.0005 = -0.0005", () => {
      const res = core.subtract("0", "0.0005");
      const str = core.numArrayToString(res);
      assert.equal(str, "-0.0005");
    });
    it("1 - 0.0005 = 0.9995", () => {
      const res = core.subtract("1", "0.0005");
      const str = core.numArrayToString(res);
      assert.equal(str, "0.9995");
    });
